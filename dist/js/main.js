  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
      form.addEventListener('submit', async e => {
        ...
        try {
          const res = await fetch(LC_Data.ajaxUrl, {
            method: 'POST',
            body: fd
          });
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderProject(p) {
      ...
      if (pillsEl) {
        pillsEl.innerHTML = (p.techStack || []).map(t => `<span class="feat-pill">${t}</span>`).join('');
      }
    }
...
(function () {
  ...
  const QUESTIONS = [{
    ...
    opts: [{
      icon: 'globe',
      title: 'I have no website yet',
      desc: 'Starting from zero — I need a professional online presence',
      score: {
        web: 3,
        ecomm: 1,
        seo: 0,
      ...
      icon: 'refresh',
      title: 'My site is outdated or not converting',
      desc: 'I have a site but it\'s not working hard enough for me',
      score: {
        web: 3,
        ecomm: 1,
        seo: 1,
      ...
      icon: 'search',
      title: 'I exist online but can\'t be found',
      desc: 'My site is decent but I\'m invisible on Google',
      score: {
        web: 0,
        ecomm: 0,
        seo: 3,
      ...
      icon: 'box',
      title: 'I want to sell products or services',
      desc: 'I need a store with a real checkout experience',
      score: {
        web: 1,
        ecomm: 3,
        seo: 0,
    ...
    opts: [{
      ...
      desc: 'I want more people finding and trusting my business',
      score: {
        web: 2,
        ecomm: 0,
        seo: 2,
      ...
      icon: 'cart',
      title: 'Start or grow online sales',
      desc: 'I want to sell directly and generate real revenue online',
      score: {
        web: 0,
        ecomm: 3,
        seo: 1,
      ...
      icon: 'award',
      title: 'Look better than my competitors',
      desc: 'My brand and site need to reflect the quality I deliver',
      score: {
        web: 2,
        ecomm: 0,
        seo: 0,
      ...
      desc: 'Ranking higher is my biggest bottleneck right now',
      score: {
        web: 0,
        ecomm: 0,
        seo: 3,
    ...
    opts: [{
      ...
      desc: 'Beauty, fitness, consulting, trades, healthcare, events',
      score: {
        web: 2,
        ecomm: 0,
        seo: 2,
      ...
      desc: 'I make, sell, or source physical or digital products',
      score: {
        web: 0,
        ecomm: 3,
        seo: 1,
      ...
      desc: 'Law, finance, tech, real estate, agencies',
      score: {
        web: 2,
        ecomm: 0,
        seo: 1,
      ...
      desc: 'Brick-and-mortar with a local customer base',
      score: {
        web: 1,
        ecomm: 1,
        seo: 3,
    ...
    opts: [{
      icon: 'sparkle',
      title: 'No logo or brand identity',
      desc: 'I need a visual identity before anything else',
      score: {
        web: 0,
        ecomm: 0,
        seo: 0,
      ...
      icon: 'check',
      title: 'I have a logo — it\'s just not great',
      desc: 'The basics are there but it feels off-brand',
      score: {
        web: 1,
        ecomm: 0,
        seo: 0,
      ...
      icon: 'thumbsup',
      title: 'Brand is solid, I need a better site',
      desc: 'Visuals are good — I need the platform to match',
      score: {
        web: 3,
        ecomm: 1,
        seo: 1,
      ...
      icon: 'zap',
      title: 'Brand and site are good — I need growth',
      desc: 'Foundation is there, I need more visibility',
      score: {
        web: 0,
        ecomm: 1,
        seo: 3,
  ...
  const RESULTS = {
    web: {
      ...
      includes: ['Fully custom responsive design', 'Up to 8 pages (Home, About, Services, etc.)', 'Contact form + Google Analytics setup', 'On-page SEO foundation', '1 round of revisions included'],
    ...
    ecomm: {
      ...
      includes: ['Shopify or WooCommerce platform setup', 'Product catalog (up to 25 products)', 'Stripe payment gateway integration', 'Order management + confirmation emails', 'Mobile-optimised checkout flow'],
    ...
    seo: {
      ...
      includes: ['Keyword research & on-page optimisation', 'Monthly performance report', 'Plugin updates & security patches', 'Content updates (up to 4 hrs/month)', 'Google Search Console setup'],
    ...
    brand: {
      ...
      includes: ['3 initial logo concepts', 'Brand colour palette + typography system', 'PNG, SVG, and PDF file formats', 'Mini brand style guide (1-page PDF)', 'Unlimited revisions on chosen concept'],
  ...
  class Quiz {
    ...
    render() {
      ...
      this.dom.dots.forEach((d, i) => {
        ...
        if (i < this.step) d.classList.add('done');else if (i === this.step) d.classList.add('active');
      });
    ...
    showResult() {
      ...
      // Determine winner
      const best = Object.keys(this.scores).reduce((a, b) => this.scores[a] >= this.scores[b] ? a : b);
      ...
      this.dom.rIncludes.innerHTML = r.includes.map(item => `
...
(function () {
  ...
  async function fetch(query) {
    ...
    try {
      ...
      const res = await window.fetch(`${LC_SEARCH.ajaxUrl}?${params}`, {
        signal: abort.signal
      });
      const data = await res.json();
...
/* harmony import */ var _modules_quiz_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/quiz.js */ "./src/modules/quiz.js");
